...
-- # 11. Actors and Directors Who Cooperated At Least Three Times
-- Table: ActorDirector
...
-- | 2           | 2.50          |
-- +-------------+---------------+
-- he average experience years for the first project is (3 + 2 + 1) / 3 = 2.00 and for the second project is (3 + 2) / 2 = 2.50
...
-- Solution 2 (same as above, without subquery. This is better!)
